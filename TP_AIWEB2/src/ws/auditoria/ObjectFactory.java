 ...
 * element interface generated in the com.monitor.webservice package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _AgregarInformeResponse_QNAME = new QName("http://webService.monitor.com/",
			"agregarInformeResponse");
	private final static QName _Log_QNAME = new QName("http://webService.monitor.com/", "log");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.monitor.webservice
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link AgregarInforme
	 * }{@code >}}
	 * 
	 */
	 ...
	 * {@link AgregarInformeResponse }{@code >}}
	 * 
	 */
	...
	public JAXBElement<AgregarInformeResponse> createAgregarInformeResponse(AgregarInformeResponse value) {
		return new JAXBElement<AgregarInformeResponse>(_AgregarInformeResponse_QNAME, AgregarInformeResponse.class,
				null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link LogDTO }
	 * {@code >}}
	 * 
	 */
