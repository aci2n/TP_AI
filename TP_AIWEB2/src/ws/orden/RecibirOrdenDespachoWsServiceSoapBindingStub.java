/**
 * RecibirOrdenDespachoWsServiceSoapBindingStub.java
 *
...
public class RecibirOrdenDespachoWsServiceSoapBindingStub extends org.apache.axis.client.Stub implements ws.orden.RecibirOrdenDespachoWs {
    ...
    public RecibirOrdenDespachoWsServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RecibirOrdenDespachoWsServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RecibirOrdenDespachoWsServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://logistica.interfaces/", "item");
            cachedSerQNames.add(qName);
            cls = ws.orden.Item.class;
            ...
            qName = new javax.xml.namespace.QName("http://logistica.interfaces/", "respuestaGenerica");
            cachedSerQNames.add(qName);
            cls = ws.orden.RespuestaGenerica.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public ws.orden.RecibirOrdenDespachoResponse recibirOrdenDespacho(ws.orden.RecibirOrdenDespacho parameters) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:RecibirOrdenDespacho");
        _call.setEncodingStyle(null);
